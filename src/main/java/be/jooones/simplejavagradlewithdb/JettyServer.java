package be.jooones.simplejavagradlewithdb;
...
public class JettyServer {
    ...
    private void createDataSourceResource(DataSource dataSource) {
        try {
            new Resource("java:comp/env/jdbc/BibliothourisDS", dataSource);
        } catch (Exception e) {
    ...
    private static BasicDataSource createDataSource() {
        ...
        dataSource.setUrl("jdbc:hsqldb:hsql://localhost/bibliothouris_web");
